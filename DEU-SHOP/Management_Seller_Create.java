...
public class Management_Seller_Create extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Management_Seller_Create frame = new Management_Seller_Create();
	 ...
	 * Create the frame.
	 */
	public Management_Seller_Create() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Seller S=new Seller(textField.getText(), textField_1.getText(), textField_6.getText(), P, radioButton.getActionCommand(), A, D);
