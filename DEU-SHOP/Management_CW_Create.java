...
public class Management_CW_Create extends JFrame {
	...
	public Management_CW_Create() {
		...
		radioButton.setBounds(138, 285, 59, 23);
		panel.add(radioButton);
		
		JRadioButton radioButton_1 = new JRadioButton("Male");
		radioButton_1.setBounds(199, 285, 109, 23);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				CargoWorker S=new CargoWorker(textField.getText(), textField_1.getText(), textField_6.getText(), P, radioButton.getActionCommand(), A, D,Integer.parseInt(textField_12.getText()));
				SelectionScreen.D.addPerson(S);
				List_CW_Button lcb = new List_CW_Button();
				lcb.setVisible(true);
				setVisible(false);			
			}
		});
		button.setBounds(334, 272, 89, 31);
		panel.add(button);
		...
		label_6.setBounds(10, 289, 46, 14);
		panel.add(label_6);
		
		lblSalary = new JLabel("Salary");
		lblSalary.setBounds(9, 264, 46, 14);
		panel.add(lblSalary);
		
		textField_12 = new JTextField();
		textField_12.setBounds(138, 263, 157, 20);
