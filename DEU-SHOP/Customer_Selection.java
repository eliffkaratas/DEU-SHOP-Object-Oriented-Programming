...
public class Customer_Selection extends JFrame {
	static Customer CC;
	...
	public Customer_Selection() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Date D = new Date(Integer.parseInt(textField_7.getText()), Integer.parseInt(textField_10.getText()),
						Integer.parseInt(textField_11.getText()));
				Customer C = new Customer(textField.getText(), textField_1.getText(), textField_6.getText(), P,
						radioButton.getActionCommand(), A, D);
				SelectionScreen.D.addPerson(C);
				CC = C;
				List_All_Products LP = new List_All_Products();
				setVisible(false);
				LP.setVisible(true);
